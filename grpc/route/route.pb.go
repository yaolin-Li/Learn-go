...
type RecommendationRequest struct {
	...
	Mode  RecommendationMode `protobuf:"varint,1,opt,name=mode,proto3,enum=RecommendationMode" json:"mode,omitempty"`
...
var file_route_proto_rawDesc = []byte{
	...
	0x22, 0x6e, 0x0a, 0x0c, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79,
	...
	0x22, 0x5e, 0x0a, 0x15, 0x52, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x64, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x27, 0x0a, 0x04, 0x6d, 0x6f, 0x64,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x13, 0x2e, 0x52, 0x65, 0x63, 0x6f, 0x6d, 0x6d,
	0x65, 0x6e, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x6f, 0x64, 0x65, 0x52, 0x04, 0x6d, 0x6f,
	0x64, 0x65, 0x12, 0x1c, 0x0a, 0x05, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	0x61, 0x72, 0x65, 0x73, 0x74, 0x10, 0x01, 0x32, 0xb7, 0x01, 0x0a, 0x0a, 0x52, 0x6f, 0x75, 0x74,
	...
	0x65, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x22, 0x00, 0x28, 0x01, 0x12, 0x33, 0x0a, 0x09,
	0x52, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x64, 0x12, 0x16, 0x2e, 0x52, 0x65, 0x63, 0x6f,
	...
	0x79, 0x61, 0x6f, 0x6c, 0x69, 0x6e, 0x2d, 0x4c, 0x69, 0x2f, 0x6c, 0x65, 0x61, 0x72, 0x6e, 0x2d,
	0x67, 0x6f, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x62, 0x06, 0x70,
...
var file_route_proto_goTypes = []interface{}{
	(RecommendationMode)(0),       // 0: RecommendationMode
	(*Point)(nil),                 // 1: Point
	(*Rectangle)(nil),             // 2: Rectangle
	(*Feature)(nil),               // 3: Feature
	(*RouteSummary)(nil),          // 4: RouteSummary
	(*RecommendationRequest)(nil), // 5: RecommendationRequest
}
var file_route_proto_depIdxs = []int32{
	1, // 0: Rectangle.lo:type_name -> Point
	1, // 1: Rectangle.hi:type_name -> Point
	1, // 2: Feature.location:type_name -> Point
	0, // 3: RecommendationRequest.mode:type_name -> RecommendationMode
	1, // 4: RecommendationRequest.point:type_name -> Point
	1, // 5: RouteGuide.GetFeature:input_type -> Point
	2, // 6: RouteGuide.ListFeatures:input_type -> Rectangle
	1, // 7: RouteGuide.RecordRoute:input_type -> Point
	5, // 8: RouteGuide.Recommend:input_type -> RecommendationRequest
	3, // 9: RouteGuide.GetFeature:output_type -> Feature
	3, // 10: RouteGuide.ListFeatures:output_type -> Feature
	4, // 11: RouteGuide.RecordRoute:output_type -> RouteSummary
	3, // 12: RouteGuide.Recommend:output_type -> Feature
